...
public class Response {
  ...
  public Response(final String version, final String id, final String method, final Result r) {
  ...
  public static class Result {
    ...
    public Result(final String code, final String message, final String txid, final String receipt,
        final int count, final List<Product> product) {
      this.message = message;
      this.code = code;
      this.count = count;
      this.product = product;
